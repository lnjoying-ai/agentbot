...
/** @type {__VLS_StyleScopedClasses['chat-container']} */ ;
/** @type {__VLS_StyleScopedClasses['info-sidebar']} */ ;
// CSS variable injection 
// CSS variable injection end 
__VLS_asFunctionalElement(__VLS_intrinsicElements.section, __VLS_intrinsicElements.section)({
    ...{ class: "multi-agent-chat" },
});
...
var __VLS_12;
/** @type {[typeof AgentInfoPanel, ]} */ ;
// @ts-ignore
const __VLS_17 = __VLS_asFunctionalComponent(AgentInfoPanel, new AgentInfoPanel({
    ...{ class: "info-sidebar" },
}));
const __VLS_18 = __VLS_17({
    ...{ class: "info-sidebar" },
}, ...__VLS_functionalComponentArgsRest(__VLS_17));
/** @type {__VLS_StyleScopedClasses['multi-agent-chat']} */ ;
